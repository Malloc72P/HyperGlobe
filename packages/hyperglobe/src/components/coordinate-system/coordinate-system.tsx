 ...
 * @returns
 */
export function CoordinateSystem({ length = 1.5, radius = 0.008 }: CoordinateSystemProps) {
  return (
    <>
      {/* X축: 빨간색 선 (오른쪽 방향) */}
      ...
      <Text position={[length, 0, 0]} fontSize={0.12} color="red" anchorX="center" anchorY="middle">
        +X
      </Text>
